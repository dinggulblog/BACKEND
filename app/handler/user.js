  ...
  async createAccountLink(req, callback) {
    try {
      ...
      await sendMail({
        ...
        body: `<a href="http://localhost:8080"><img src="https://dinggul.me/uploads/logo.png" style="display: block; width: 280px; margin: 0 auto;"/></a>
        ...
        <div style="text-align: center; margin-top: 1rem; color: #868e96; font-size: 0.85rem;">
          <div>위 버튼을 클릭하시거나, 다음 링크를 열으세요:<br/>
            <a style="color: #b197fc;" href="http://localhost:8080/pwd-reset?code=${code}">
